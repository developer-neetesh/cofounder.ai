...
from ai.prompts.steps.step_1_prompt import (
    cofounder_roadmap_step_1_prompt, 
    cofounder_roadmap_step_1_prompt_v2,
    cofounder_roadmap_step_1_prompt_v3
)
from ai.prompts.steps.step_2_prompt import cofounder_roadmap_step_2_prompt_v1
from ai.prompts.steps.step_3_prompt import cofounder_roadmap_step_3_prompt_v1
from ai.prompts.steps.step_4_prompt import cofounder_roadmap_step_4_prompt_v1
from ai.prompts.steps.step_5_prompt import cofounder_roadmap_step_5_prompt_v1
from ai.prompts.steps.step_6_prompt import cofounder_roadmap_step_6_prompt_v1
from ai.prompts.steps.step_7_prompt import cofounder_roadmap_step_7_prompt_v1
...
async def entrepreneur_step_1(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_1_prompt_v3()
    # messages = await get_messages_history(messages)
    # print("###############", messages)
    
    query = [
        {"role": "system", "content": step_1_prompt},
        *messages,
...
async def entrepreneur_step_2(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_2_prompt_v1()
...
async def entrepreneur_step_3(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_3_prompt_v1()
...
async def entrepreneur_step_4(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_4_prompt_v1()
...
async def entrepreneur_step_5(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_5_prompt_v1()
...
async def entrepreneur_step_6(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_6_prompt_v1()
...
async def entrepreneur_step_7(state: StateStructured):
    ...
    step_1_prompt = await cofounder_roadmap_step_7_prompt_v1()
